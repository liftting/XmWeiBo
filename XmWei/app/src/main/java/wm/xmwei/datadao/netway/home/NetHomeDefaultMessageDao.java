 ...
 *
 */
public class NetHomeDefaultMessageDao {
...
//        }
    ...
    public NetHomeDefaultMessageDao(String access_token) {

        this.access_token = access_token;
        this.count = XmSettingUtil.getMsgCount();
    }

    public NetHomeDefaultMessageDao setSince_id(String since_id) {
        this.since_id = since_id;
        return this;
    }

    public NetHomeDefaultMessageDao setMax_id(String max_id) {
        this.max_id = max_id;
        return this;
    }

    public NetHomeDefaultMessageDao setCount(String count) {
        this.count = count;
        return this;
    }

    public NetHomeDefaultMessageDao setPage(String page) {
        this.page = page;
        return this;
    }

    public NetHomeDefaultMessageDao setBase_app(String base_app) {
        this.base_app = base_app;
        return this;
    }

    public NetHomeDefaultMessageDao setFeature(String feature) {
        this.feature = feature;
        return this;
    }

    public NetHomeDefaultMessageDao setTrim_user(String trim_user) {
