...
public class PagerSlidingTabIndicator extends HorizontalScrollView {
    ...
    private int tabTextColor = 0xFF5f5f5f;
    ...
    public PagerSlidingTabIndicator(Context context) {
        this(context, null);
    }

    public PagerSlidingTabIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PagerSlidingTabIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabSelectedTextSize = tabTextSize + 2; // 设置选中后的字体大小 + 4px
        ...
        dividerPadding = a.getDimensionPixelSize(R.styleable.PageSlidingIndicator_indicatorDividerPadding, dividerPadding);
        ...
        textAllCaps = a.getBoolean(R.styleable.PageSlidingIndicator_indicatorTextAllCaps, textAllCaps);
	...
	/*	canvas.drawRect(lineLeft, height - indicatorHeight, lineRight, height, rectPaint);*/
        ...
        // 绘制这个三角形,你可以绘制任意多边形  
        // Path path = new Path();
        //path.moveTo(center,height - indicatorHeight);// 此点为多边形的起点  
    ...
    private class PageListener implements OnPageChangeListener {
		...
		/*	 View v = mAdapter.getItem(position).getView();
