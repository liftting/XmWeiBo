...
import wm.xmwei.core.lib.support.view.gif.GifImageView;

/**
 *
 *
 */
public class XmClipGifImageView extends GifImageView {
    ...
    public XmClipGifImageView(Context context) {
        this(context, null, -1);
    }

    public XmClipGifImageView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public XmClipGifImageView(Context context, AttributeSet attrs, int defStyle) {
