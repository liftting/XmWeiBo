...
public class UserDomain implements Parcelable {
    ...
    public static final Creator<UserDomain> CREATOR =
            new Creator<UserDomain>() {
                public UserDomain createFromParcel(Parcel in) {
                    UserDomain userBean = new UserDomain();
    ...
    public boolean equals(Object o) {
        return o instanceof UserDomain && id.equals(((UserDomain) o).getId());
    }
