...
import wm.xmwei.util.DataUtils;
import wm.xmwei.util.XmTimeUtils;

/**
 *
 */
public class DataMessageDomain extends DataItemDomain implements Parcelable {
    ...
    private long mills;
    private DataMessageDomain retweeted_status;
    private UserDomain user;
    private LocationGeoDomain geo;
    ...
    public static final Parcelable.Creator<DataMessageDomain> CREATOR =
            new Parcelable.Creator<DataMessageDomain>() {
                public DataMessageDomain createFromParcel(Parcel in) {
                    DataMessageDomain messageBean = new DataMessageDomain();
                    ...
                    messageBean.retweeted_status = in
                            .readParcelable(DataMessageDomain.class.getClassLoader());
                    messageBean.user = in.readParcelable(UserDomain.class.getClassLoader());
                    messageBean.geo = in.readParcelable(LocationGeoDomain.class.getClassLoader());
                ...
                public DataMessageDomain[] newArray(int size) {
                    return new DataMessageDomain[size];
                }
            };
    ...
    public LocationGeoDomain getGeo() {
        return geo;
    }

    public void setGeo(LocationGeoDomain geo) {
        this.geo = geo;
    }
    ...
    public DataMessageDomain getRetweeted_status() {
        return retweeted_status;
    }

    public void setRetweeted_status(DataMessageDomain retweeted_status) {
        this.retweeted_status = retweeted_status;
    }

    public String getListviewItemShowTime() {
        return XmTimeUtils.getListTime(this);
    }
    ...
    public SpannableString getListViewSpannableString() {
        if (!TextUtils.isEmpty(listViewSpannableString)) {
            ...
            DataUtils.addJustHighLightLinks(this);
            return listViewSpannableString;
        }
    }
    ...
    public boolean equals(Object otherObject) {
        ...
        if (!(otherObject instanceof DataMessageDomain)) {
            return false;
        }

        DataMessageDomain other = (DataMessageDomain) otherObject;
