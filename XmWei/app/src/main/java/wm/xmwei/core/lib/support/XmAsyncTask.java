 ...
 *
 */
public abstract class XmAsyncTask<Params, Progress, Result> {
     ...
     */
    public final XmAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     *                               {@link android.os.AsyncTask.Status#RUNNING} or {@link android.os.AsyncTask.Status#FINISHED}.
     */
    public final XmAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        ...
        final XmAsyncTask mTask;

        final Data[] mData;

        AsyncTaskResult(XmAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
