 ...
 */
package wm.xmwei.core.lib.support.eventbus.util;
...
/**
 * Executes an {@link wm.xmwei.core.lib.support.eventbus.util.AsyncExecutor.RunnableEx} using a thread pool. Thrown exceptions are propagated by posting failure events of any
...
public class AsyncExecutor {
    ...
    /** Posts an failure event if the given {@link wm.xmwei.core.lib.support.eventbus.util.AsyncExecutor.RunnableEx} throws an Exception. */
