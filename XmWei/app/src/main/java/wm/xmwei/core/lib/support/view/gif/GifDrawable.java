...
public class GifDrawable extends Drawable implements Animatable, MediaPlayerControl {
     ...
     * Convenience wrapper for {@link wm.xmwei.core.lib.support.view.gif.GifDrawable#GifDrawable(java.io.FileDescriptor)}
     *
     * @param afd source
    ...
    /**
     * An {@link wm.xmwei.core.lib.support.view.gif.GifDrawable#GifDrawable(android.content.res.Resources, int)} wrapper but returns null
     ...
     * For GifDrawables constructed from {@link java.io.InputStream} and {@link java.io.FileDescriptor} -1 is always
     * returned.
     * In case of {@link java.io.File}, file path, byte array and {@link java.nio.ByteBuffer} length is always
     * known.
     *
     ...
     * representing a {@link android.graphics.Color}.
