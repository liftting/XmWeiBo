 ...
 * Date: 12-8-14
 */
public class XmWeiboException extends Exception {
    ...
    public String getError() {
        ...
        if (!TextUtils.isEmpty(error)) {
            ...
            int i = XmApplication.getInstance().getResources()
                    .getIdentifier(name, "string", XmApplication.getInstance().getPackageName());

            try {
                result = XmApplication.getInstance().getString(i);
                ...
                if (!TextUtils.isEmpty(oriError)) {
                    ...
                    result = XmApplication.getInstance().getString(R.string.unknown_error_error_code) + error_code;
                }
            }
        }
    ...
    public XmWeiboException() {

    }

    public XmWeiboException(String detailMessage) {
        error = detailMessage;
    }

    public XmWeiboException(String detailMessage, Throwable throwable) {
        error = detailMessage;
    }
