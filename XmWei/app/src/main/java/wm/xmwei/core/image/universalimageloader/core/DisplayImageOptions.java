 ...
 *******************************************************************************/
package wm.xmwei.core.image.universalimageloader.core;
...
import wm.xmwei.core.image.universalimageloader.core.assist.ImageScaleType;
import wm.xmwei.core.image.universalimageloader.core.display.BitmapDisplayer;
import wm.xmwei.core.image.universalimageloader.core.display.SimpleBitmapDisplayer;
import wm.xmwei.core.image.universalimageloader.core.download.ImageDownloader;
import wm.xmwei.core.image.universalimageloader.core.process.BitmapProcessor;
 ...
 * <ul>
 * <li>with {@link wm.xmwei.core.image.universalimageloader.core.DisplayImageOptions.Builder}:<br />
 * <b>i.e.</b> :
 * <code>new {@link wm.xmwei.core.image.universalimageloader.core.DisplayImageOptions}.{@link wm.xmwei.core.image.universalimageloader.core.DisplayImageOptions.Builder#Builder() Builder()}.{@link wm.xmwei.core.image.universalimageloader.core.DisplayImageOptions.Builder#cacheInMemory() cacheInMemory()}.
 * {@link wm.xmwei.core.image.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(int) showImageOnLoading()}.{@link wm.xmwei.core.image.universalimageloader.core.DisplayImageOptions.Builder#build() build()}</code><br />
 * </li>
...
public final class DisplayImageOptions {
	...
	/**
	 * Builder for {@link wm.xmwei.core.image.universalimageloader.core.DisplayImageOptions}
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 */
	public static class Builder {
		 ...
		 * image aware view} during image loading.
		 * This option will be ignored if {@link wm.xmwei.core.image.universalimageloader.core.DisplayImageOptions.Builder#showImageOnLoading(int)} is set.
		 */
		 ...
		 * image aware view} if empty URI (null or empty
		 * string) will be passed to <b>ImageLoader.displayImage(...)</b> method.
		 * This option will be ignored if {@link wm.xmwei.core.image.universalimageloader.core.DisplayImageOptions.Builder#showImageForEmptyUri(int)} is set.
		 */
		 ...
		 * image aware view} if some error occurs during
		 * requested image loading/decoding.
		 * This option will be ignored if {@link wm.xmwei.core.image.universalimageloader.core.DisplayImageOptions.Builder#showImageOnFail(int)} is set.
		 */
		...
		/** Builds configured {@link wm.xmwei.core.image.universalimageloader.core.DisplayImageOptions} object */
